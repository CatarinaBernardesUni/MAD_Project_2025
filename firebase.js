console.log('✅ firebase.js executed'); // prints firebase.js executed
...
console.log('🔥 Firebase App:', app.name); //  prints Firebase App: [DEFAULT]
export const db = getFirestore(app); 
console.log('📚 Firestore DB initialized:', db); // prints Firestore DB initialized: undefined
