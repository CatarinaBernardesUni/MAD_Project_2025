...
export default function StudentEnrollCard({ student, onEdit, onSelect }) {
    ...
    <Text style={styles.initials}>
      ...
      {expanded && (
        <View style={styles.actions}>
          ...
          <TouchableOpacity style={styles.selectBtn} onPress={() => onSelect(student)}>
            <Text style={styles.actionText}>Select Student</Text>
          </TouchableOpacity>
        </View>
      )}
    </TouchableOpacity>
